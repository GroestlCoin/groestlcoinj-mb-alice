...
import com.google.groestlcoin.crypto.TransactionSignature;
...
import static com.google.groestlcoin.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable, IsMultiBitClass {
    ...
    // These are serialized in both groestlcoin and java serialization.
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.groestlcoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.groestlcoin.it/wiki/Contracts
     ...
     * This is useful in certain types of <a href="http://en.groestlcoin.it/wiki/Contracts">contracts</a>, such as
