...
public class Peer {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that groestlcoin-qt is single threaded and processes messages in order.
    ...
    private void blockChainDownloadLocked(Sha256Hash toHash) throws IOException {
        ...
        //
        //   https://en.groestlcoin.it/wiki/Protocol_specification#getblocks
        //
     ...
     * Once the pong is received the value returned by {@link com.google.groestlcoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.groestlcoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.groestlcoin.core.Peer#ping()} has never
