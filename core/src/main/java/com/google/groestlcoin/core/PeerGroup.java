...
import com.google.groestlcoin.core.Peer.PeerHandler;
import com.google.groestlcoin.discovery.PeerDiscovery;
import com.google.groestlcoin.discovery.PeerDiscoveryException;
...
public class PeerGroup extends AbstractIdleService implements TransactionBroadcaster {
    ...
    // pipeline with the groestlcoin serializer ({@code TCPNetworkConnection}) downstream
     ...
     * <a href="https://en.groestlcoin.it/wiki/BIP_0014">BIP 14</a>.
     *
     ...
     * peers. By using this with {@link com.google.groestlcoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.groestlcoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.groestlcoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.groestlcoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.groestlcoin.core.Peer#ping()}.
     */
