...
public abstract class Message implements Serializable {
    ...
    /**
     * Serialize this message to a byte array that conforms to the groestlcoin wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the groestlcoin wire format.
     *
     * @param stream
     * @throws IOException
     */
