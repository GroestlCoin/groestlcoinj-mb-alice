...
import com.google.groestlcoin.script.ScriptBuilder;
...
import static com.google.groestlcoin.core.Utils.doubleDigest;
import static com.google.groestlcoin.core.Utils.doubleDigestTwoBuffers;
import static com.google.groestlcoin.core.Utils.scryptDigest;
 ...
 * <a href="http://www.groestlcoin.org/groestlcoin.pdf">the Bitcoin technical paper</a> for
...
public class Block extends Message {
     ...
     *
     * <p>The half-life is controlled by {@link com.google.groestlcoin.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    private void parseHeader() throws ProtocolException {
        ...
        hash = new Sha256Hash(Utils.reverseBytes(Groestl.digest(bytes, offset, cursor)/*Utils.doubleDigest(payload, offset, cursor)*/));
     ...
     * {@link com.google.groestlcoin.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
