 ...
 */
package com.google.groestlcoin;
...
public class IsMultiBitClassTest extends TestCase {
    private static final String GOOGLE_PREFIX = "com.google.groestlcoin.";
    ...
    private void checkClass(String className) throws ClassNotFoundException {
        ...
        if (interfaces == null) {
            ...
            for (int i = 0; i < interfaces.length; i++) {
                if (interfaces[i].getName().equals("com.google.groestlcoin.IsMultiBitClass")) {
                    success = true;
                    break;
                }
            }
